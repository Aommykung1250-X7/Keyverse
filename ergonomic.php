...
<head>
  ...
  <title>Ergonomic Keyboards - KEYVERSE</title> 
...
<body>
 ...
 <section class="keyboard-section">
    ...
    <div class="product-container">
        <?php
            // ดึงข้อมูล Ergonomic Keyboards
            $sql_ergo = "SELECT * FROM products WHERE category = 'Ergonomic' ORDER BY product_id ASC";
            $result_ergo = $conn->query($sql_ergo);

            if ($result_ergo->num_rows > 0) {
                while ($row = $result_ergo->fetch_assoc()) {
        ?>
        ...
        <?php
                ...
                echo "<p class='no-products'>No Ergonomic keyboards found.</p>";
            } 
