...
<head>
  ...
  <title>Membrane Keyboards - KEYVERSE</title> 
...
<body>
 ...
 <section class="keyboard-section">
    ...
    <div class="product-container">
        <?php
            // ดึงข้อมูล Membrane Keyboards
            $sql_membrane = "SELECT * FROM products WHERE category = 'Membrane' ORDER BY product_id ASC";
            $result_membrane = $conn->query($sql_membrane);

            if ($result_membrane->num_rows > 0) {
                while ($row = $result_membrane->fetch_assoc()) {
        ?>
        ...
        <?php
                ...
                echo "<p class='no-products'>No Membrane keyboards found.</p>";
            } 
